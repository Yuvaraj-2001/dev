export default function Footer(){
    return <div className="p-10 border-t border-b border-slate-200">
        <div className="">
            <div className="flex justify-between">
                <div>
                    <div className="text-slate-200 text-2xl">YUVARAJ</div>
                    <div className="text-purple-500 text-xl pt-2">Frontend Developer</div>
                </div>
                <div>
                    <div className="text-slate-200 text-2xl">Social Media</div>
